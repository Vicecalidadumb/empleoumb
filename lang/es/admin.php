...
/**
 * Strings for component 'admin', language 'es', branch 'MOODLE_25_STABLE'
 *
 * @package   admin
...
$string['formatuninstallconfirm'] = '{$a} se desinstalará. No hay cursos actualmente que lo utilicen. ¿Desea continuar?';
$string['formatuninstalled'] = 'Todos los datos asociados con la extensión \'{$a->plugin}\' han sido borrados de la base de datos. Para completar su eliminación (y evitar que la extensión se re-instale de nuevo), debería eliminar ahora el directorio {$a->directory} del servidor.';
...
$string['quizattemptsupgradedmessage'] = 'En Moodle 2.1 se produjo una importante actualización de las preguntas. Entonces fue posible retrasar partes de la actualización de base de datos para que se ejecutaran posteriormente. Ahora, antes de actualizar a Moodle 2.7, se debe completar esta actualización.';
...
$string['reportsdeleteconfirm'] = 'Está a punto de borrar completamente el informe \'{$a}\'. Esta acción borrará toda la información de la base de datos asociada con esta extensión. ¿Está seguro de que quiere continuar?';
...
$string['toolsdeleteconfirm'] = 'Está a punto de borrar completamente la herramienta de administración \'{$a}\'. Esto borrará completamente todo lo referente a esta extensión (plugin) de la base de datos asociada. ¿Está seguro de que quiere continuar?';
