...
/**
 * Strings for component 'moodle', language 'es', branch 'MOODLE_25_STABLE'
 *
 * @package   moodle
...
$string['force'] = 'Forzar';
$string['forcedmodeinbrackets'] = '{$a} (modo forzado)';
...
* Formato SCORM  - Visualiza de un paquete SCORM en la primera sección de la página del curso (como alternativa al uso del módulo SCORM / AICC)
