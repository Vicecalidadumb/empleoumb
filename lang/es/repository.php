...
/**
 * Strings for component 'repository', language 'es', branch 'MOODLE_25_STABLE'
 *
 * @package   repository
...
$string['errorpostmaxsize'] = 'El archivo subido puede que exceda la diectiva de php.ini max_post_size';
