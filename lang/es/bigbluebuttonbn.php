...
/**
 * Strings for component 'bigbluebuttonbn', language 'es', branch 'MOODLE_25_STABLE'
 *
...
$string['mod_form_field_allmoderators'] = 'Permitir a todos los participantes ser moderadores';
