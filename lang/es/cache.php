...
/**
 * Strings for component 'cache', language 'es', branch 'MOODLE_25_STABLE'
 *
 * @package   cache
...
$string['cachedef_plugininfo_base'] = 'Información de extensiones - base';
$string['cachedef_plugininfo_block'] = 'Información de extensiones - bloques';
$string['cachedef_plugininfo_filter'] = 'Información de extensiones - filtros';
$string['cachedef_plugininfo_mod'] = 'Información de extensiones - módulos de actividad';
$string['cachedef_plugininfo_portfolio'] = 'Información de extensiones - portfolios';
$string['cachedef_plugininfo_repository'] = 'Información de extensiones - repositorios';
$string['cachedef_pluginlist'] = 'Lista de extensiones';
$string['cachedef_plugintypes'] = 'Tipos de extensión';
