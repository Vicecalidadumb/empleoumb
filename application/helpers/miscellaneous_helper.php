    ...
    foreach ($documents as $document) {
        ...
        switch ($document->TIPO_DOCUMENTO_ID) {
            ...
            case 4:
                ...
                $TIPO_DOCUMENTO_ID_TOTAL++;
                break;
            case 51:$TIPO_DOCUMENTO_ID_1++;$TIPO_DOCUMENTO_ID_TOTAL++;break;
            case 52:$TIPO_DOCUMENTO_ID_1++;$TIPO_DOCUMENTO_ID_TOTAL++;break;
            case 53:$TIPO_DOCUMENTO_ID_1++;$TIPO_DOCUMENTO_ID_TOTAL++;break;
            case 54:$TIPO_DOCUMENTO_ID_1++;$TIPO_DOCUMENTO_ID_TOTAL++;break;
        }
    }
...
function encrypt_id_v2($id) {
    return 'UMBEMP' . str_pad($id, 3, "0", STR_PAD_LEFT);
}
